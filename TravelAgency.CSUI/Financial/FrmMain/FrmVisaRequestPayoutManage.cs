    ...
    _bllVisa.GetModelList(" (EntryTime between '" +
        ...
        private void AddToSelectGroup()
        {
            ...
            for (int i = 0; i < _listToAddToGroup.Count; i++)
            {
                ...
                log.ActType = ActType._01AddToExist; //操作记录为添加到已有团号
        ...
        private void 提交请款ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            foreach (var visa in list)
            {
                ...
                if (visa.SubmitFlag == 1)
                {
                    ...
                    FrmSetStringValue frmSetStringValue = new FrmSetStringValue($"设置备注2,{visa.GroupNo}已请款 {qzList.Count}次", visa.Tips2);
        ...
        private void 设置请款标记ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FrmSetStringValueComboBox frm = new FrmSetStringValueComboBox("设置请款标记", Model.Enums.RequestFlag.List, list[0].RequestFlag);
