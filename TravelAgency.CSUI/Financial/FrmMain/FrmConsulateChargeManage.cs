...
{
    public partial class FrmConsulateChargeManage : Form
    {
        private readonly TravelAgency.BLL.ConsulateCharge _bllConsulateCharge = new TravelAgency.BLL.ConsulateCharge();
        ...
        public FrmConsulateChargeManage(bool b4Add = false)
        {
        ...
        {
            _recordCount = _bllConsulateCharge.GetRecordCount(_where);
        ...
        public void LoadDataToDataGridView(int page) //刷新后保持选中
        {
            ...
            dataGridView1.DataSource = _bllConsulateCharge.GetListByPageOrderByCountry(_curPage,_pageSize,_where);
