...
{
    public partial class FrmOccupationValue : Form
    {
        private string[] infos = { "教师", "学生", "会计师", "家庭主妇", "副经理", "经理", "商人","个体","公务员" };
        private RadioButton[] _rtbns;
        private string _outInfo;
        public string Result { get; set; }
        public FrmOccupationValue()
        {
            InitializeComponent();
            StartPosition = FormStartPosition.CenterParent;
        }

        public FrmOccupationValue(string info)
            : this()
        {
        ...
        private void InitControls()
        {
            ...
            for (int i = 0; i < infos.Length; i++)
            {
                ...
                if (i <= infos.Length / 2)
                    ...
                    rbtn.Location = new Point(100, 25 * (i - infos.Length / 2) + 2);
