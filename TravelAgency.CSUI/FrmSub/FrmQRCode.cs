...
namespace TravelAgency.CSUI.FrmSub
{
    public partial class FrmQRCode : Form
    {
        ...
        private readonly Model.VisaInfo _model;
        ...
        public FrmQRCode(Model.VisaInfo model):this()
        {
            _model = model;
            UpdateQrInfoByModel();
        }

        public FrmQRCode(string info):this()
        {
            _qrinfo = info;
        ...
        private void UpdateQrInfoByModel()
        {
            if (_model == null)
                return;
            _qrinfo = MyQRCode.GenQrInfo(_model);
            txtQRCodeInfo.Text = _qrinfo;
        }

        private void SetQrCodeToPicBox()
        {
            //string qrInfo = MyQRCode.GenQrInfo(_model);
            ...
            Image qrCodeImage = _qrCode.EncodeToImage(_qrinfo, QRCodeSaveSize.Size660X660);

            //PicHandler.DrawStringOnPicture(image);
            
            picQRCode.Image = PicHandler.GenFinalImage(qrCodeImage, _qrinfo,_model);
        ...
        private void btnSavePic_Click(object sender, EventArgs e)
        {
            ...
            if(!_qrinfo.Contains("State:"))
                defaultName = _qrinfo.Split('|')[0] + "_QRCode.png";

            string dstName = GlobalUtils.ShowSaveFileDlg(defaultName,
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Cancel)
                return;
            int widthInInk = (int)(PageWidth * 100 * 0.0393701); //毫米转换成英寸
            int heightInInk = (int)(PageHeight * 100 * 0.0393701);
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(picQRCode.Image, 0.0f, 0.0f, 200.0f, 200.0f);
        }
