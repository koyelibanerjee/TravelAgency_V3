...
{
    public partial class FrmRemarkValue : Form
    {
        private string[] infos = { "夫妻", "一家人", "父子", "母子", "父女", "母女", "亲属" };
        private RadioButton[] _rtbns;
        private string _outInfo;
        public string Result { get; set; }
        public FrmRemarkValue()
        {
            InitializeComponent();
            StartPosition = FormStartPosition.CenterParent;
        }

        public FrmRemarkValue(string info)
            : this()
        {
        ...
        private void InitControls()
        {
            ...
            for (int i = 0; i < infos.Length; i++)
            {
                ...
                if (i <= infos.Length / 2)
                    ...
                    rbtn.Location = new Point(80, 25 * (i - infos.Length / 2) + 2);
