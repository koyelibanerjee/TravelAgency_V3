...
namespace TravelAgency.BLL  
{
    ...
    /// 分页获取数据
    /// </summary>
    public List<TravelAgency.Model.JobAssignment> GetListByPage(string where, string orderby,int startIndex, int endIndex)
    {
    ...
    /// 分页获取数据
    /// </summary>
    public List<TravelAgency.Model.JobAssignment> GetListByPage(int pageIndex, int pageSize, string where, string orderby)
    {
    ...
    /// 分页获取数据
    /// </summary>
    public List<TravelAgency.Model.JobAssignment> GetListByPageOrderByPK(int pageIndex, int pageSize, string where)
    {
        int startIndex = (pageIndex - 1) * pageSize + 1;
        int endIndex = pageIndex * pageSize;
        string orderby = "";
    ...
    /// 新增list
    /// </summary>		
    public int AddList(List<TravelAgency.Model.JobAssignment> list)
    {
        int res = 0;
    ...
    /// 更新list
    /// </summary>
    public int UpdateList(List<TravelAgency.Model.JobAssignment> list)
    {
        int res = 0;
        foreach (var item in list)
        {
    ...
    /// 删除list
    /// </summary>    
    public bool DeleteList(List<TravelAgency.Model.JobAssignment> list)
    {
