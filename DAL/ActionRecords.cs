...
namespace TravelAgency.DAL
{
	...
	public partial class ActionRecords
	{
		...
		public TravelAgency.Model.ActionRecords GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,ActType,WorkId,UserName,VisaInfo_id,Visa_id,Type,EntryTime,Country from ActionRecords ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,ActType,WorkId,UserName,VisaInfo_id,Visa_id,Type,EntryTime,Country ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,ActType,WorkId,UserName,VisaInfo_id,Visa_id,Type,EntryTime,Country ");
			strSql.Append(" FROM ActionRecords ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
