...
namespace TravelAgency.DAL  
{
		...
		public partial class Orders
	{
		...
		public bool Update(TravelAgency.Model.Orders model)
		{
            ...
            strSql.Append(" RefundState = @RefundState , ");                                    
            strSql.Append(" OrderColor = @OrderColor , ");                                    
            strSql.Append(" LabelRemark = @LabelRemark  ");            			
...
SqlParameter[] parameters = {
            ...
            parameters[7].Value = model.GuestUseTime;                        
            parameters[8].Value = model.PurchaseNum;                        
            parameters[9].Value = model.OrderAmount;                        
            parameters[10].Value = model.ReallyPay;                        
            parameters[11].Value = model.PlatformActivity;                        
            parameters[12].Value = model.GuestOrderTime;                        
            parameters[13].Value = model.WaitorOrderTime;                        
            parameters[14].Value = model.WaitorConfirmTime;                        
            parameters[15].Value = model.ReserveTime;                        
            parameters[16].Value = model.DiningTime;                        
            parameters[17].Value = model.DiningShop;                        
            parameters[18].Value = model.CheckMoneyTime;                        
            parameters[19].Value = model.RefundAmout;                        
            parameters[20].Value = model.GuestRefundApplyTime;                        
            parameters[21].Value = model.WaitorRefundApplyTime;                        
            parameters[22].Value = model.WaitorName;                        
            parameters[23].Value = model.IsPraise;                        
            parameters[24].Value = model.RefundReason;                        
            parameters[25].Value = model.WaitorRemark;                        
            parameters[26].Value = model.JpOrderNo;                        
            parameters[27].Value = model.OrderWay;                        
            parameters[28].Value = model.OperOrderTime;                        
            parameters[29].Value = model.JpConfirmTime;                        
            parameters[30].Value = model.ReplyWaitorConfirmTime;                        
            parameters[31].Value = model.ReplyResult;                        
            parameters[32].Value = model.SettlePrice;                        
            parameters[33].Value = model.ExchangeRate;                        
            parameters[34].Value = model.OperRemark;                        
            parameters[35].Value = model.RealIntoAccountTime;                        
            parameters[36].Value = model.TyperName;                        
            parameters[37].Value = model.Commission;                        
            parameters[38].Value = model.WaitorCommision;                        
            parameters[39].Value = model.AdminRemark;                        
            parameters[40].Value = model.OperName;                        
            parameters[41].Value = model.GuestInfoTypedIn;                        
            parameters[42].Value = model.MoneyType;                        
            parameters[43].Value = model.ComboName;                        
            parameters[44].Value = model.DepartureDate;                        
            parameters[45].Value = model.OrderState;                        
            parameters[46].Value = model.RefundState;                        
            parameters[47].Value = model.OrderColor;                        
            parameters[48].Value = model.LabelRemark;                        
			...
			if(row != null)
			{
																																				...
																																				if(row["OrderState"]!=null && row["OrderState"].ToString()!="")
				{
					model.OrderState= row["OrderState"].ToString();
																																...
																																if(row["RefundState"]!=null && row["RefundState"].ToString()!="")
				{
					model.RefundState= row["RefundState"].ToString();
				}
																												if(row["OrderColor"]!=null && row["OrderColor"].ToString()!="")
				{
					model.OrderColor=int.Parse(row["OrderColor"].ToString());
				}
																																				if(row["LabelRemark"]!=null && row["LabelRemark"].ToString()!="")
				{
					model.LabelRemark= row["LabelRemark"].ToString();
				}
