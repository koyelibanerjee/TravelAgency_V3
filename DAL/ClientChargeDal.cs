...
namespace TravelAgency.DAL
{
	...
	public partial class ClientCharge
	{
        ...
        /// <returns></returns>
        public DataSet GetDataByPageOrderByClientName(int start, int end, string where)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("SELECT * from(SELECT *,ROW_NUMBER() OVER(ORDER BY id asc) as num from ClientCharge");
            ...
            sb.Append(")");
            sb.Append(" as t WHERE t.num>=@Start AND t.num<=@End order by Client asc"); 
