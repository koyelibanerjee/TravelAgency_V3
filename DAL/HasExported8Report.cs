...
namespace TravelAgency.DAL
{
	...
	public partial class HasExported8Report
	{
		...
		public bool Exists(Guid VisaInfo_id)
		{
			...
			strSql.Append("select count(1) from HasExported8Report");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update HasExported8Report set ");
			...
			parameters[1].Value = model.VisaInfo_id;
		...
		public bool Delete(Guid VisaInfo_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from HasExported8Report ");
			strSql.Append(" where VisaInfo_id=@VisaInfo_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@VisaInfo_id", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = VisaInfo_id;
		...
		public TravelAgency.Model.HasExported8Report GetModel(Guid VisaInfo_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 VisaInfo_id,EntryTime from HasExported8Report ");
			strSql.Append(" where VisaInfo_id=@VisaInfo_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@VisaInfo_id", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = VisaInfo_id;

			TravelAgency.Model.HasExported8Report model=new TravelAgency.Model.HasExported8Report();
		...
		/// 得到一个对象实体
		/// </summary>
		public TravelAgency.Model.HasExported8Report DataRowToModel(DataRow row)
		{
			TravelAgency.Model.HasExported8Report model=new TravelAgency.Model.HasExported8Report();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select VisaInfo_id,EntryTime ");
			strSql.Append(" FROM HasExported8Report ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from HasExported8Report T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "HasExported8Report";
