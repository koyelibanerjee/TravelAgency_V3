...
namespace TravelAgency.DAL
{
    ...
    public partial class OrderGuest
    {
        ...
        public int Add(TravelAgency.Model.OrderGuest model)
        {
            ...
            strSql.Append("OrdersId,GuestId,GuestType,GuestName,GuestNamePinYin,GuestSex,GuestBirthday,GuestPhone,GuestWeChat,GuestEMail,GuestPassportNo,GuestLastNightHotel,GuestCountry,Price,Position");
        ...
        public TravelAgency.Model.OrderGuest GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id, OrdersId, GuestId, GuestType, GuestName, GuestNamePinYin, GuestSex, GuestBirthday, GuestPhone, GuestWeChat, GuestEMail, GuestPassportNo, GuestLastNightHotel, GuestCountry, Price, Position  ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id, OrdersId, GuestId, GuestType, GuestName, GuestNamePinYin, GuestSex, GuestBirthday, GuestPhone, GuestWeChat, GuestEMail, GuestPassportNo, GuestLastNightHotel, GuestCountry, Price, Position  ");
            strSql.Append(" FROM OrderGuest ");
            if (strWhere.Trim() != "")
            {
