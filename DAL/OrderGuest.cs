...
namespace TravelAgency.DAL  
{
		...
		public partial class OrderGuest
	{
		...
		/// </summary>
            ...
            strSql.Append("OrdersId,GuestId,GuestType,GuestName,GuestNamePinYin,GuestSex,GuestBirthday,GuestPhone,GuestWeChat,GuestEMail,GuestPassportNo,GuestLastNightHotel,GuestCountry");
...
SqlParameter[] parameters = {
		...
		public TravelAgency.Model.OrderGuest GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id, OrdersId, GuestId, GuestType, GuestName, GuestNamePinYin, GuestSex, GuestBirthday, GuestPhone, GuestWeChat, GuestEMail, GuestPassportNo, GuestLastNightHotel, GuestCountry  ");			
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id, OrdersId, GuestId, GuestType, GuestName, GuestNamePinYin, GuestSex, GuestBirthday, GuestPhone, GuestWeChat, GuestEMail, GuestPassportNo, GuestLastNightHotel, GuestCountry  ");
			strSql.Append(" FROM OrderGuest ");
			if(strWhere.Trim()!="")
			{
