...
namespace TravelAgency.DAL
{
    ...
    public partial class visa_copy
    {
        ...
        public bool Exists(Guid Visa_id)
        {
            ...
            strSql.Append("select count(1) from visa_copy");
            strSql.Append(" where ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update visa_copy set ");
        ...
        public bool Delete(Guid Visa_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from visa_copy ");
            strSql.Append(" where Visa_id=@Visa_id ");
            SqlParameter[] parameters = {
                    new SqlParameter("@Visa_id", SqlDbType.UniqueIdentifier,16)         };
            parameters[0].Value = Visa_id;
        ...
        public TravelAgency.Model.visa_copy GetModel(Guid Visa_id)
        {
            ...
            TravelAgency.Model.visa_copy model = new TravelAgency.Model.visa_copy();
        ...
        /// </summary>
        public TravelAgency.Model.visa_copy DataRowToModel(DataRow row)
        {
            TravelAgency.Model.visa_copy model = new TravelAgency.Model.visa_copy();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from visa_copy T ");
