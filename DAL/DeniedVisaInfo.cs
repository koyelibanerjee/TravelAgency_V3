...
namespace TravelAgency.DAL  
{
		...
		public partial class DeniedVisaInfo
	{
		...
		/// </summary>
            ...
            strSql.Append("EntryTime,Name,PassportNo,DenyReason,Remark");
...
SqlParameter[] parameters = {
		...
		public TravelAgency.Model.DeniedVisaInfo GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id, EntryTime, Name, PassportNo, DenyReason, Remark  ");			
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id, EntryTime, Name, PassportNo, DenyReason, Remark  ");
			strSql.Append(" FROM DeniedVisaInfo ");
			if(strWhere.Trim()!="")
			{
