...
namespace TravelAgency.DAL  
{
		...
		public partial class AuthUser
	{
		...
		/// </summary>
            ...
            strSql.Append("WorkId,Account,UserName,Password,UserMobile,DepartmentId,RID,RoleName,District");
...
SqlParameter[] parameters = {
		...
		public TravelAgency.Model.AuthUser GetModel(string WorkId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select WorkId, Account, UserName, Password, UserMobile, DepartmentId, RID, RoleName, District  ");			
