...
namespace TravelAgency.DAL
{
	...
	public partial class WorkerQueue
	{
		...
		public int Add(TravelAgency.Model.WorkerQueue model)
		{
			...
			strSql.Append("WorkId,UserName,IsBusy,CanAccept,Priority)");
		...
		public TravelAgency.Model.WorkerQueue GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,WorkId,UserName,IsBusy,CanAccept,Priority from WorkerQueue ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,WorkId,UserName,IsBusy,CanAccept,Priority ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,WorkId,UserName,IsBusy,CanAccept,Priority ");
			strSql.Append(" FROM WorkerQueue ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WorkerQueue";
