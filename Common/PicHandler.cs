...
namespace TravelAgency.Common
{
    ...
    public static class PicHandler
    {
        ...
        {
            //Bitmap dst = new Bitmap(350, 175);
            Bitmap dst = new Bitmap(1400, 800);
            //dst.
            Graphics g = Graphics.FromImage(dst);
            g.DrawImage(qrImage, new Rectangle(0, 0, 660, 660));
            DrawStringOnPicture(dst, infoBottom, new PointF(20.0f, 665.0f), 40);
            if (model == null)
                return dst;

            DrawStringOnPicture(dst, "东瀛假日", new PointF(750.0f, 50.0f), 80);
            DrawStringOnPicture(dst, model.Name, new PointF(750.0f, 250.0f), 80);
            DrawStringOnPicture(dst, model.PassportNo, new PointF(750.0f, 450.0f), 80);
            return dst;
        }
        ...
        public static void DrawStringOnPicture(Image image, string info, PointF pointF, int fontSzie)
        {
            Graphics g = Graphics.FromImage(image);
            Font font = new Font("Consolas", fontSzie, FontStyle.Bold);
            g.DrawString(info, font, Brushes.DarkRed, pointF);
        }
        ...
        public static void DrawImageInCenter(Image img1, Image img2)
        {
            Graphics g = Graphics.FromImage(img1);
            g.DrawImage(img2, (img1.Width - img2.Width) / 2, (img1.Height - img2.Height) / 2);
        }
        #endregion
