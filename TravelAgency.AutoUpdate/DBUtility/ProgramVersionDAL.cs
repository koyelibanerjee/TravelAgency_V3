...
namespace TravelAgency.AutoUpdate.DBUtility
{
    ...
    /// </summary>
    public partial class ProgramVersionDAL
    {
        public ProgramVersionDAL()
        { }
        #region  BasicMethod
        ...
        public ProgramVersionModel GetModel(int id)
        {
            ...
            ProgramVersionModel model = new ProgramVersionModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ProgramVersionModel DataRowToModel(DataRow row)
        {
            ProgramVersionModel model = new ProgramVersionModel();
            if (row != null)
            {
